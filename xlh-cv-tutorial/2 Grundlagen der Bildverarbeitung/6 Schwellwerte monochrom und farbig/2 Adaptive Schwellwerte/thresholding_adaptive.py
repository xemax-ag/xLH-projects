...
threshold = cv2.putText(threshold, 'Schwellwert', (50, 50), font, 0.8, WHITE, 2, cv2.LINE_AA)
threshold_inv = cv2.putText(threshold_inv, 'Schwellwert invers', (50, 50), font, 0.8, BLACK, 2, cv2.LINE_AA)
masked = cv2.putText(masked, 'Maskierung', (25, 25), font, 0.8, WHITE_3, 2, cv2.LINE_AA)
masked_inv = cv2.putText(masked_inv, 'Maskierung invers', (25, 25), font, 0.8, WHITE_3, 2, cv2.LINE_AA)
...
cv2.imwrite('img/thresholding_adaptive_1.png', result_1[0:-2, 0:-2])
cv2.imwrite('img/thresholding_adaptive_2.png', result_2[0:-2, 0:-2])
