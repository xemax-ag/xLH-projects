"""
https://github.com/supataragul/StreamBuffer/blob/master/bufferStream.py
"""
...
fn = "rtsp://192.168.31.31:8554/cam"
...
def rtsp_read_buffer():
    ...
    while (ret):
        ...
        if frame_buffer.full():
            frame_buffer.get()
        # Read frame-by-frame
        # capturing eachq frame
        ret, buffer_frame = cap.read()
        # buffer_frame = cv2.rotate(buffer_frame, cv2.ROTATE_180)
        buffer_frame = cv2.flip(buffer_frame, 0)
